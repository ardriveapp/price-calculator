...
export const faqQuestionsAnswers = [
	{
		...
		answer: (
			<p>
				...
				mp3) will vary in sizes, but some rules of thumb are: 1 document 0.31 MiB (320KiB); 1 HD Photo 2.5 MiB;
				3.5 minute Song 3.5 MiB; 1 minute HD video 100 MiB.
			</p>
		)
	},
	{
	...
	},
	{
		...
		answer: (
			<p>
				...
				result in a fluctuating data price, with a 30 day average of $6 per GiB. However, for most files these
